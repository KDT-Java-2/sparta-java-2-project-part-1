CREATE TABLE user (
                       ...
                       status VARCHAR(20) DEFAULT 'NORMAL' COMMENT 'NORMAL, LOCK',
...
CREATE TABLE cart (
                          id BIGINT AUTO_INCREMENT PRIMARY KEY,
                          user_id BIGINT NOT NULL COMMENT '장바구니를 소유한 사용자 ID',
                          product_id BIGINT NOT NULL COMMENT '장바구니에 담긴 상품 ID',
                          quantity INT NOT NULL DEFAULT 1 COMMENT '장바구니에 담긴 상품의 수량',
                          created_at DATETIME(6) DEFAULT CURRENT_TIMESTAMP(6),
                          updated_at DATETIME(6) DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)
);
...
CREATE TABLE refund (
                          id BIGINT AUTO_INCREMENT PRIMARY KEY,
                          purchase_product_id BIGINT NOT NULL COMMENT '환불 요청이 속한 구매 아이템 ID',
