package com.sparta.bootcamp.shop.domain.user.repository;

import java.util.List;

import com.querydsl.core.types.dsl.BooleanExpression;
import com.querydsl.jpa.impl.JPAQueryFactory;
import com.sparta.bootcamp.shop.domain.user.dto.QUserResponse;
import com.sparta.bootcamp.shop.domain.user.dto.UserResponse;
import com.sparta.bootcamp.shop.domain.user.entity.QUser;
...
import static com.sparta.bootcamp.shop.domain.purchase.entity.QPurchase.purchase;
import static com.sparta.bootcamp.shop.domain.user.entity.QUser.user;
