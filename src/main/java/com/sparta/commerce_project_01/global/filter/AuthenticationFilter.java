package com.sparta.commerce_project_01.global.filter;
...
import com.sparta.commerce_project_01.domain.auth.service.CustomUserDetailsService;
        ...
        if (authentication == null || !authentication.isAuthenticated() ||
          ...
          if (session != null) {
            ...
            if (!ObjectUtils.isEmpty(userId) && !ObjectUtils.isEmpty(email)) {
              ...
              // 여기서 Spring Security 컨텍스트에 인증 정보를 설정
