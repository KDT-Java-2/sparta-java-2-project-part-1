package com.socialcommerce.domain.refund.entity;

import com.socialcommerce.common.enums.RefundStatus;
import com.socialcommerce.common.enums.RefundType;
...
public class Refund {
    ...
    private RefundType type; // ALL or PARTIAL
