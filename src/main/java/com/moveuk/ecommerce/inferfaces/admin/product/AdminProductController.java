...
public class AdminProductController {
    ...
    public ApiResponse<AdminProductResponse.ProductResponseV1> createProduct(@ModelAttribute AdminProductRequest.ProductRegisterV1 productRegisterV1){
    ...
    public ApiResponse<AdminProductResponse.ProductResponseV2> updateProduct(@PathVariable Long productId, @ModelAttribute AdminProductRequest.ProductRegisterV1 productRegisterV2){
