...
public class AdminCategoryController {
    ...
    public ApiResponse<AdminCategoryResponse.CategoryResponseV1> createCategory(@RequestBody @Valid AdminCategoryRequest.CategoryRegisterV1 categoryRegisterV1){
    ...
    public ApiResponse<List<AdminCategoryResponse.AdminCategoryTreeResponse>> updateCategory(@PathVariable Long categoryId, @ModelAttribute @Valid AdminCategoryRequest.CategoryRegisterV1 categoryRegisterV1 ){
